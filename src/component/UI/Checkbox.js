...
export default class CheckBox extends Component {
  ...
  genCheckedImage() {
    let source
    if (this.props.isIndeterminate) {
      source = require('../../assets/images/checkboxUnchecked.png')
    } else {
      source = this.props.disabled
        ? require('../../assets/images/checkboxDisabled.png')
        : this.props.isChecked
        ? require('../../assets/images/checkboxChecked.png')
        : require('../../assets/images/checkboxUnchecked.png')
    }
